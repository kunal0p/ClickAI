...
while True:
    ...
    if(len(lmlist)!=0):
       ...
       # print(fingers)
        ...
        if(fingers[0]==0 and fingers[1]==1 and fingers[4]==0 and fingers[2]==1 and fingers[4]==0 and fingers[3]==0):
            length,img,lineinfo=detector.findDistance(8,12,img)
            #print(length)
            if(length<30):
        ...
        if(fingers[4]==1 and fingers[1]==0 and fingers[2]==0 and fingers[3]==0 and fingers[0]==0):
